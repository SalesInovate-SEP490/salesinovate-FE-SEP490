...
const AddCampaignContact: React.FC<{
    campaignId?: any, getList?: any, data?: any, memberStatusUpdate?: any;
    contactId?: any
}> = ({ campaignId, getList, data, memberStatusUpdate, contactId }) => {
    ...
    const handleSave = () => {
        ...
        const newCampaignMember = {
            contactId: contactId,
            campaignId: contactCampaign?.campaignId,
            memberStatus: contactCampaign?.campaignMemberStatusId
        }
        addContactToCampaign([newCampaignMember])
            .then(response => {
                Swal.close();
                if (response.code === 1) {
    ...
    return (
        <div className="modal custom-modal fade" id="add_contact_campaign" role="dialog">
                                ...
                                <div className="row">
                                    <div className="col-md-12">
                                        ...
                                        <Select
                                            ...
                                            onChange={(e: any) => setContactCampaign({ ...contactCampaign, campaignId: e?.id })}
                                            value={contactCampaign?.campaignId ? campainOptions.find(item => item.id === contactCampaign?.campaignId) : null}
                                            isClearable={true}
                                        />
                                    </div>
                                    <div className="col-md-12">
...
export default AddCampaignContact;
