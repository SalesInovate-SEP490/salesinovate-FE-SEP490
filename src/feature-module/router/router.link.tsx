...
import Opportunities from "../crm/opportunities/opportunities";
import OpportunityDetail from "../crm/opportunities";
import Accounts from "../crm/account/accounts";
import AccountDetail from "../crm/account";
import Contacts from "../crm/contact/contacts";
import ContactDetail from "../crm/contact";
import EmailTemplates from "../crm/emailTemplate/emailTemplate";
import EmailTemplateDetail from "../crm/emailTemplate";
import Chatter from "../crm/chatter";
import CampaignList from "../crm/campaign";
import CampaignDetail from "../crm/campaign/campaignDetail";
import CampaignComplete from "../crm/campaign/campaignComplete";
import CampaignArchieve from "../crm/campaign/campaignArchieve";
import Reports from "../crm/report";
import ListReport from "../crm/report/reports";
import Product from "../crm/product";
import ProductDetail from "../crm/product/productDetail";
import PriceBook from "../crm/priceBook";
import PriceBookDetail from "../crm/priceBook/priceBookDetail";
import ListFile from "../crm/files/files";
import RecycleBin from "../crm/recycleBin/RecycleBin";
import OpportunityKanban from "../crm/opportunities/opportunityKanban";
import Error403 from "../pages/error/error-403";
import ProductsPriceBook from "../crm/priceBook/ListProduct";
import ProductsOpportunity from "../crm/opportunities/ListProduct";
import PriceBookByProduct from "../crm/product/ListPriceBook";
import Contracts from "../crm/contract/index";
import ContractDetail from "../crm/contract/contractDetail";
import ContractHistory from "../crm/contract/contractHistory";
import LeadMembers from "../crm/campaign/LeadMembers";
import ContactMembers from "../crm/campaign/ContactMembers";
import ListOpportunityInfluenced from "../crm/campaign/ListOpportunityInfluenced";
import CampaignMemberStatus from "../crm/campaign/CampaignMembers";
import ListCampaignInfluenced from "../crm/opportunities/ListCampaignInfluenced";
import ListContactRoles from "../crm/opportunities/ListContactRoles";
import Orders from "../crm/order";
import CalendarDetail from "../mainMenu/apps/calendarDetail";
import OrderDetail from "../crm/order/OrderDetail";
import ProductsOrder from "../crm/order/ListProduct";
import Quotes from "../crm/quote";
import QuoteDetail from "../crm/quote/QuoteDetail";
import ProductsQuote from "../crm/quote/ListProduct";
import ListQuote from "../crm/opportunities/ListQuote";
import ListOrdersInContract from "../crm/contract/ListOrder";
import LogCallDetail from "../crm/activity/LogCallDetail";
import Configs from "../crmSetting/config";
...
export const publicRoutes = [
  ...
  {
    path: route.leadMemberCampaign,
    element: <LeadMembers />,
    route: Route,
  },
  {
    path: route.contactMemberCampaign,
    element: <ContactMembers />,
    route: Route,
  },
  {
    path: route.influencedOpportunities,
    element: <ListOpportunityInfluenced />,
    route: Route,
  },
  {
    path: route.memberStatus,
    element: <CampaignMemberStatus />,
    route: Route,
  },
  {
    ...
    path: route.priceBookDetail,
    element: <PriceBookDetail />,
    route: Route,
  },
  {
    path: route.productsPriceBook,
    element: <ProductsPriceBook />,
    route: Route,
  },
  {
  ...
  {
    path: route.contractDetail,
    element: <ContractDetail />,
    route: Route,
  },
  {
    path: route.contractHistory,
    element: <ContractHistory />,
    route: Route,
  },
  {
    path: route.contractOrders,
    element: <ListOrdersInContract />,
    route: Route,
  },
  {
    path: route.logCall,
    element: <LogCallDetail />,
    route: Route,
  },
  {
    path: route.orders,
  ...
  {
    path: route.ordersDetails,
    element: <OrderDetail />,
    route: Route,
  },
  {
    path: route.orderProducts,
  ...
  {
    path: route.quotesDetails,
    element: <QuoteDetail />,
    route: Route,
  },
  {
    path: route.quoteProducts,
    element: <ProductsQuote />,
    route: Route,
  },
  {
    path: route.listQuoteOpportunity,
    element: <ListQuote />,
    route: Route,
  },
  {
  ...
  {
    path: route.opportunitiesDetails,
    element: <OpportunityDetail />,
    route: Route
  },
  {
    path: route.opportunityKanban,
    element: <OpportunityKanban />,
    route: Route
  },
  {
    path: route.listProductInOpportunity,
    element: <ProductsOpportunity />,
    route: Route
  },
  {
    path: route.listCampaignInfluenced,
    element: <ListCampaignInfluenced />,
    route: Route
  },
  {
    path: route.listContactRole,
    element: <ListContactRoles />,
    route: Route
  },
  {
    path: route.accounts,
  ...
  {
    path: route.PriceBookByProduct,
    element: <PriceBookByProduct />,
    route: Route,
  },
  {
    path: route.emailTemplate,
    element: <EmailTemplates />,
    route: Route,
  },
  {
    path: route.emailTemplateDetails,
