...
import { COMPARE } from "../../../core/data/json/compare";
                                        ...
                                        <div className="row">
                                            <div className="col-md-3">
                                                <Select
                                                    ...
                                                    styles={customStyles}
                                                    name="priceBookName"
                                                    value={COMPARE.find((item: any) => item?.value === listCompare?.priceBookName)}
                                        ...
                                        <div className="row">
                                            <div className="col-md-3">
                                                <Select
                                                    ...
                                                    value={COMPARE.find((item: any) => item?.value === listCompare?.priceBookDescription)}
                                        ...
                                        <div className="row">
                                            <div className="col-md-3">
                                                <Select
                                                    ...
                                                    styles={customStyles}
                                                    name="isActive"
                                                    value={COMPARE.find((item: any) => item?.value === listCompare.isActive)}
                                        ...
                                        <div className="row">
                                            <div className="col-md-3">
                                                <Select
                                                    ...
                                                    value={COMPARE.find((item: any) => item?.value === listCompare.isStandardPriceBook)}
