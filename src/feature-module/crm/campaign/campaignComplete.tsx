...
const CampaignComplete = () => {
  ...
  const getListCampaign = async (pageNo: number, pageSize: number) => {
    ...
    getCampaign(params).then((data: any) => {
  ...
  const filteredCampaigns = viewList.filter((campaign) => campaign.status === 'Completed');
                ...
                <ul className="nav">
                  <li>
                    <Link to={route.campaign} className={isLinkActive(route.campaign) ? "active" : ""}>
                      {t("CAMPAIGN.LIST_CAMPAIGN")}<span>24</span>
                    </Link>
                  </li>
                  <li>
                  ...
                  <li>
                    <Link to={route.campaignArchieve} className={isLinkActive(route.campaignArchieve) ? "active" : ""}> {t("CAMPAIGN.IN_PROGRESS_CAMPAIGN")}</Link>
                  </li>
                </ul>
              </div>
              {/* Campaign Tab */}
